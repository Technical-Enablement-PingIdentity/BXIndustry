...
export const RealEstateDashboard = ({ images }) => {
  ...
  return (
    <div className="real-estate">
      ...
      {dashboard.dv_buttons?.length && 
        <div className="container">
          <div className="container__col dashboard__actions">
        ...
        <div className="container">
          <div className="container__col">
            <div className="places-filter objects-section__header">
              <h1 className="places-filter__title">{dashboard.title}</h1>
          ...
          <div className="objects-list">
            {dashboard.objects_section.map(({ title, subtitle, description, button }, index) => (
      ...
      <section className="offers-section offers-section--dashboard">
        <div className="container">
          <div className="container__col">
            <div className="offers-section-header offers-section__header">
              <h3 className="offers-section-header__title">{dashboard.apartments_section.title}</h3>
            </div>
          </div>
          <div className="offers-list">
            {dashboard.apartments_section.items.map(({ title, description, price, location }, index) => (
