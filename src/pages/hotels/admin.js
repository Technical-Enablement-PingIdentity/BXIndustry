...
export const HotelsAdmin = ({ images }) => {
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="dashboard-info">
            ...
            <div className="dashboard-info__side dashboard-info__side--sidebar">
              <p className="dashboard-section__title dashboard-section__title--sm">{admin.title}</p>
              <div className="layalty-block dashboard-sidebar">
                <p className="layalty-block__title">{admin.sidebar.title}</p>
      ...
      <section className="admin-offer-section" style={{ backgroundImage: `url(${images.offer})` }}>
        <div className="container admin-offer-section__content">
          <div className="container__col">
            <h5 className="admin-offer-section__title">{admin.offer_section.title}</h5>
            <button className="admin-offer-section__button">{admin.offer_section.button}</button>
          </div>
        </div>
      </section>
      {admin.dv_widget && (
